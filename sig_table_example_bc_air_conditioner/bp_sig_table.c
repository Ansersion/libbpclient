...
const SigTypeU SIG_SYS_ENV_TEMP_MIN = {.t_flt = -40}, SIG_SYS_ENV_TEMP_MAX = {.t_flt = 120}, SIG_SYS_ENV_TEMP_DEF = {.t_flt = 25};
const SigTypeU SIG_SYS_ENV_HUMIDITY_MIN = {.t_flt = 0}, SIG_SYS_ENV_HUMIDITY_MAX = {.t_flt = 100}, SIG_SYS_ENV_HUMIDITY_DEF = {.t_flt = 50};
const SigTypeU SIG_SYS_SETTING_TEMP_MIN = {.t_flt = 0}, SIG_SYS_SETTING_TEMP_MAX = {.t_flt = 1}, SIG_SYS_SETTING_TEMP_DEF = {.t_flt = 0};
const SigTypeU SIG_SYS_SETTING_HUMIDITY_MIN = {.t_flt = 0}, SIG_SYS_SETTING_HUMIDITY_MAX = {.t_flt = 1}, SIG_SYS_SETTING_HUMIDITY_DEF = {.t_flt = 0};
...
const BP_SigTable g_SysSigTable[] = 
{
	...
	{SIG_SYS_ENV_TEMP, SIG_TYPE_FLT, ENABLE_STATISTICS, ENABLE_DISPLAY, 0, DISABLE_ALARM, SIG_PERM_RO, ALARM_CLASS_NONE, NO_CUSTOM_INFO, RESERVED_FIELD, (SigTypeU *)&SIG_SYS_ENV_TEMP_MIN, (SigTypeU *)&SIG_SYS_ENV_TEMP_MAX, (SigTypeU *)&SIG_SYS_ENV_TEMP_DEF, ALARM_DELAY_DEFAULT, ALARM_DELAY_DEFAULT},
	{SIG_SYS_ENV_HUMIDITY, SIG_TYPE_FLT, ENABLE_STATISTICS, ENABLE_DISPLAY, 0, DISABLE_ALARM, SIG_PERM_RO, ALARM_CLASS_NONE, NO_CUSTOM_INFO, RESERVED_FIELD, (SigTypeU *)&SIG_SYS_ENV_HUMIDITY_MIN, (SigTypeU *)&SIG_SYS_ENV_HUMIDITY_MAX, (SigTypeU *)&SIG_SYS_ENV_HUMIDITY_DEF, ALARM_DELAY_DEFAULT, ALARM_DELAY_DEFAULT},
	{SIG_SYS_SETTING_TEMP, SIG_TYPE_FLT, ENABLE_STATISTICS, ENABLE_DISPLAY, 0, DISABLE_ALARM, SIG_PERM_RW, ALARM_CLASS_NONE, NO_CUSTOM_INFO, RESERVED_FIELD, (SigTypeU *)&SIG_SYS_SETTING_TEMP_MIN, (SigTypeU *)&SIG_SYS_SETTING_TEMP_MAX, (SigTypeU *)&SIG_SYS_SETTING_TEMP_DEF, ALARM_DELAY_DEFAULT, ALARM_DELAY_DEFAULT},
	{SIG_SYS_SETTING_HUMIDITY, SIG_TYPE_FLT, ENABLE_STATISTICS, ENABLE_DISPLAY, 0, DISABLE_ALARM, SIG_PERM_RW, ALARM_CLASS_NONE, NO_CUSTOM_INFO, RESERVED_FIELD, (SigTypeU *)&SIG_SYS_SETTING_HUMIDITY_MIN, (SigTypeU *)&SIG_SYS_SETTING_HUMIDITY_MAX, (SigTypeU *)&SIG_SYS_SETTING_HUMIDITY_DEF, ALARM_DELAY_DEFAULT, ALARM_DELAY_DEFAULT},
};
...
const BP_UINT8 g_SysMapDis_1[1] = {0x08 | 0x04 | 0x02 | 0x01};

const BP_SysSigMap g_SysSigMap[] = 
{
	{DIST_BASIC_MSK | DIST_CLASS_1_MSK, sizeof(g_SysMapDis_0) / sizeof(BP_UINT8), g_SysMapDis_0}, 
	{DIST_TEMP_HUMIDITY_MSK | DIST_CLASS_1_MSK | DIST_END_FLAG_MSK, sizeof(g_SysMapDis_1) / sizeof(BP_UINT8), g_SysMapDis_1}, 
};
