...
const BP_SigTable g_SysSigTable[] = 
{
	...
	{SIG_SYS_SERIAL_NUMBER, SIG_TYPE_STR, ENABLE_STATISTICS, DISABLE_DISPLAY, 0, DISABLE_ALARM, SIG_PERM_RO, ALARM_CLASS_NONE, HAS_CUSTOM_INFO, RESERVED_FIELD, (SigTypeU *)&STRING_DEFAULT_VALUE, (SigTypeU *)&STRING_DEFAULT_VALUE, (SigTypeU *)&STRING_DEFAULT_VALUE, 5, 5},
